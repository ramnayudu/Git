<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditInfo.aspx.cs" Inherits="IFocusMembersRegistrations.EditInfo" %>
...
if (d.type === "File Size") {
$("#lblmsg1").html('File Size Should not exceed 200 KB');
}
},
onComplete: function () {
$("#lblmsg1").html('');
...
<body>
   <form id="form1" runat="server"  class="register" style="vertical-align:top;">
       ...
       <div>
            <asp:LinkButton ID="lnkPreview" runat="server" OnClick="lnkPreview_Click" Font-Bold="True" ForeColor="Maroon">Prev</asp:LinkButton>
          
          
          <asp:TextBox ID="txtGoto" runat="server" Width="70px" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px"></asp:TextBox>&nbsp;&nbsp;<asp:Button ID="btnGetRecord" runat="server" Text="Go To MemberId" OnClick="btnGetRecord_Click" BackColor="#0066FF" Font-Bold="True" ForeColor="White" ValidationGroup="b" />
               <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="Enter only Numbers" ControlToValidate="txtGoto" Display="Dynamic" SetFocusOnError="True" ValidationExpression="^[0-9]*$" ValidationGroup="b" ForeColor="Red"></asp:RegularExpressionValidator>
           <asp:LinkButton ID="lnkNext" runat="server" OnClick="lnkNext_Click" Font-Bold="True" ForeColor="Maroon">Next</asp:LinkButton>
