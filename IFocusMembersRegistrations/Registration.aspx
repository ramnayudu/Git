...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#txtDoj").datepicker({ dateFormat: 'dd/mm/yy' }).bind("change", function () {
...
{
  var chkListModules= document.getElementById ('<%= cvmodulelist.ClientID %>');
...
<body>
        ...
        <p style="padding-left:600px;color:#0189D1;font-weight:bold">
            <br />Welcome <asp:Label ID="lblUser" runat="server"></asp:Label> &nbsp;&nbsp;, <asp:LinkButton ID="lnkLogout" runat="server" Font-Bold="True" ForeColor="#0189D1" OnClick="lnkLogout_Click">Logout</asp:LinkButton></p>
                      <p align="center"> 
...
<asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="Enter Correct Format" ControlToValidate="txtBloodGroup" Display="Dynamic" SetFocusOnError="True" ValidationExpression="(A|B|AB|O)[+-]" ValidationGroup="v"></asp:RegularExpressionValidator>
                ...
                <p>
                 ...
                 <p style="color:red;padding-left:110px">
                     <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="Enter 10 digits Contact No" ControlToValidate="ContactNo" Display="Dynamic" SetFocusOnError="True" ValidationExpression="[0-9]{10}" ValidationGroup="v"></asp:RegularExpressionValidator>
                    </p>
                 <p>
               ...
               <%--<asp:RequiredFieldValidator ID="reqPhone" runat="server" 
                        ...
                        <asp:RegularExpressionValidator ID="regphone" runat="server" ErrorMessage="Enter 10 digits Contact No" ControlToValidate="AlternatePhone" Display="Dynamic" SetFocusOnError="True" ValidationExpression="[0-9]{10}" ValidationGroup="v"></asp:RegularExpressionValidator>
                </p>
                 <p>
                    <label>Email *
                    </label>
                  ...
                  <p style="color:red;padding-left:110px">
                     <asp:RegularExpressionValidator ID="regemail" runat="server" ErrorMessage="Enter Valid Email" ControlToValidate="Email" Display="Dynamic"  SetFocusOnError="True" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ValidationGroup="v"></asp:RegularExpressionValidator></p>
                 <p>
                ...
                <p>
                    ...
                    <asp:TextBox ID="txtAddress" runat="server" CssClass="long" Height="60px" style="border: 1px solid #E1E1E1" MaxLength="250" TextMode="MultiLine"></asp:TextBox>
            ...
            <fieldset class="row3">
                ...
                <p>
                    ...
                    <asp:TextBox id="txtDoj" runat="server" MaxLength="20" TabIndex="11" 
                        CssClass="long"  Width="195px"  BorderWidth="1px" BorderColor="#E1E1E1" BorderStyle="Solid" placeholder="Click here to show datepicker"></asp:TextBox>
                </p>
                <p style="color:red;padding-left:110px">
               ...
               <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                ...
                <p  runat="server" id="p3">
                    ...
                    <input type="text"   runat="server" id="Skills"  maxlength="35" tabindex="16"/></p>
                ...
                <p style="padding-left:100PX"><asp:CustomValidator runat="server" ID="cvmodulelist"
  ClientValidationFunction="ValidateModuleList"
  ErrorMessage="Select Sapthaswa" ForeColor="Red" Display="Dynamic" SetFocusOnError="True" ValidationGroup="v" ></asp:CustomValidator></p>
...
<input type="file" name="filUpload" id="filUpload" runat="server" accept=".jpg files"  onchange="showimagepreview(this)" tabindex="19" /><br />
    ...
    <p style="padding-left:300px">
        <asp:Button ID="btnsubmit" runat="server" Text="Submit" CssClass="button" 
            onclick="btnsubmit_Click" ValidationGroup="v" TabIndex="25" ForeColor="White" />&nbsp;
  ...
  <fieldset class="row1">
                ...
                <p style="padding-left:150px">
                    <asp:Button ID="btnSearch" Text="Search Members"  runat="server" BackColor="#607D8B" 
                          Font-Bold="True" Font-Size="15px" ForeColor="White" 
                        onclick="btnSearch_Click" Height="30px" />
                        
                    <asp:Button ID="btExcel" Text="Download Complete Data" Visible="false"  onclick="btnExport_Click"  
